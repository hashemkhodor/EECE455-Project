...
class AES:
    ...
    def encrypt(self, plaintext):
        ...
        for i in range(1, 11):
            ...
            print("##############################")
        print("Before int to hex")
        print(plaintext_formatted)
        print(intTOHEX(plaintext_formatted))
...
if __name__ == "__main__":
    ...
    c = AES(key)
    print(c.expand_key(key))
    print("#############HHHHHHHHHHHHSSHHSJSIOOJ;OAISHNDHWDFOPWJ[O###########")
    print(intTOHEX(c.encrypt(plaintext)))
